...
5. [Design Principles](#design-principles-)
   - [Messaging Framework with Fault Injection](#-messaging-framework-with-fault-injection)
   ...
   - [Election](#-election)
   - [Asynchronous Followers](#-asynchronous-followers)
   - [Persist Log to Disk and Use Byte Offsets as Message ID](#-persist-log-to-disk-and-use-byte-offsets-as-message-id)
   - [Push-based/ Pull-based Subscriber](#-push-based-pull-based-subscriber)
   - [Reads From Followers](#-reads-from-followers)
